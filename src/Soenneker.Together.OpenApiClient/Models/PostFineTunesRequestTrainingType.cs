...
namespace Soenneker.Together.OpenApiClient.Models
{
    ...
    public partial class PostFineTunesRequestTrainingType : IComposedTypeWrapper, IParsable
    {
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Together.OpenApiClient.Models.PostFineTunesRequestTrainingType"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.Together.OpenApiClient.Models.PostFineTunesRequestTrainingType CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            var result = new global::Soenneker.Together.OpenApiClient.Models.PostFineTunesRequestTrainingType();
