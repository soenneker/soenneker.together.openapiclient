...
using System;
namespace Soenneker.Together.OpenApiClient.Deployments.Storage.Item
{
    /// <summary>
    /// Builds and executes requests for operations under \deployments\storage\{filename}
    /// </summary>
    ...
    public partial class WithFilenameItemRequestBuilder : BaseRequestBuilder
    {
        ...
        public WithFilenameItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/deployments/storage/{filename}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Together.OpenApiClient.Deployments.Storage.Item.WithFilenameItemRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public WithFilenameItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/deployments/storage/{filename}", rawUrl)
        {
        }
        /// <summary>
...
#nullable restore
        ...
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Soenneker.Together.OpenApiClient.Deployments.Storage.Item.WithFilenameItemRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Soenneker.Together.OpenApiClient.Deployments.Storage.Item.WithFilenameItemRequestBuilder(rawUrl, RequestAdapter);
        }
    }
}
